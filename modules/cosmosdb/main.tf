...
resource "azurerm_cosmosdb_sql_container" "Sapphire_dedicated" {
  ...
  account_name          = azurerm_cosmosdb_account.cosmosdb.name
  #Sapphire
  database_name         = azurerm_cosmosdb_sql_database.dbs[0].name
...
resource "azurerm_cosmosdb_sql_container" "siteexporter" {
  ...
  account_name          = azurerm_cosmosdb_account.cosmosdb.name
  #SiteExporter
  database_name         = azurerm_cosmosdb_sql_database.dbs[2].name
...
resource "azurerm_cosmosdb_sql_container" "Sapphire2_pkey_siteid_dedicated" {
  ...
  account_name          = azurerm_cosmosdb_account.cosmosdb.name
  #Sapphire2
  database_name         = azurerm_cosmosdb_sql_database.dbs[1].name
